...
export default defineComponent({
  ...
  setup() {
    ...
    const onDelete = (record) => {
      axios.delete("/admin/admin/admin/delete/" + record.id).then((response) => {
    ...
    const handleOk = () => {
      axios.post("/admin/admin/admin/save", admin.value).then((response) => {
    ...
    const handleQuery = (param) => {
      ...
      loading.value = true;
      axios.get("/admin/admin/admin/query-list", {
        params: {
          page: param.page,
          size: param.size
        }
