...
public class DbUtil {
    ...
    public static String password = "zzb200166";
     ...
     * @throws Exception
     */
    public static List<com.wbu.train.generator.generator.util.Field> getColumnByTableName(String tableName) throws Exception {
        List<com.wbu.train.generator.generator.util.Field> fieldList = new ArrayList<>();
        Connection conn = getConnection();
        Statement stmt = conn.createStatement();
        ...
        if (rs != null) {
            while(rs.next()) {
                ...
                com.wbu.train.generator.generator.util.Field field = new com.wbu.train.generator.generator.util.Field();
