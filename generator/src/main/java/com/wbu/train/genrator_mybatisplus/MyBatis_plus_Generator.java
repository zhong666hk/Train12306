...
//        String absolutePath = File.separator + "template";
...
//                //自定义模板
//                .templateConfig(builder -> {builder.controller(absolutePath+File.separator+"controller.java");
//                    builder.entity(absolutePath+File.separator+"entity.java");
//                    builder.service(absolutePath+File.separator+"service.java");
//                    builder.service(absolutePath+File.separator+"serviceImpl.java");
//                })
//                .execute();
//    }
//}
